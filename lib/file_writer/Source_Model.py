...
#        self.Longitude = Longitude
        ...
        self.initialize()
        if self.depth_changed == True:
            print('!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\nThe depths have been changed \n!!!!!!!!!!!!!!!!!!!!!!')
...
#                                            print ColX[indexes[0]],ColY[indexes[0]]
    ...
    def FaultProperties(self,Name_of_fault):   
        ...
        reduce_depth_test = 0. #ratio of reduction of the depth
        if reduce_depth_test != 0. and self.lower_sismo_depth >= 17.1:
            self.depth_changed = True
            self.lower_sismo_depth = self.lower_sismo_depth - self.lower_sismo_depth*reduce_depth_test
