...
class checking_the_input():
    ...
    def initialize(self): 
        ...
        nb_inter = 20
        (seismological_moment_rate, catalog_cum_rate) = plt_catalog.plt_catalog(Model_list,self.File_bg,
        ...
        (total_list_ScL,total_list_dimension_used,
         ...
         total_list_scenario_name,total_list_MFD_type,mega_mfd_cummulative,total_list_model) = Plot_mfd.plt_mfd(self.Run_name,mega_MFD,scenarios_names_list,ScL_complet_list,
        ...
        Sampling_analysis.sampling_analysis(self.Run_name,Model_list,m_Mmax,b_sample,a_s_model,
                                            ...
                                            total_list_model,bining_in_mag)
        ...
        if plot_rup_freq == True :
            ...
            EQ_rates_for_each_fault.plt_EQ_rates(self.Run_name,mega_MFD,df_mega_MFD,scenarios_names_list,ScL_complet_list,
